...
const Brouchuredata = () => {
  ...
  const fetchData = async () => {
    const res = await fetch(
      `${import.meta.env.VITE_API_URL}/api/v1/brochure`
    );
  ...
  const handleUpdate = async () => {
    await fetch(
      `${import.meta.env.VITE_API_URL}/api/v1/brochure/${editingId}`,
      {
        method: "PUT",
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-6">📥 Brochure Requests</h2>
