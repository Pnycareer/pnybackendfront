...
const CourseModulesTable = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`http://localhost:8080/api/coursemodel/${id}`);
      // Remove from UI
  ...
  return (
    <>
      <divc className="flex justify-end">
        <Link to="/addcoursemodel" className="bg-blue-500 p-2 rounded">
          Add Module
        </Link>
      </divc>
      <div className="p-6">
